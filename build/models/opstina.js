var OpstinaSchema = (function () {
    function OpstinaSchema(payload, filter) {
        ...
        this.joinType = "LEFT";
        this.joinMeta = [];
        this.insertQuery = " (postanskiBroj, nazivOpstine, idMesta) VALUES(".concat((_a = this.payload) === null || _a === void 0 ? void 0 : _a.postanskiBroj, ",'").concat((_b = this.payload) === null || _b === void 0 ? void 0 : _b.nazivOpstine, "',").concat((_c = this.payload) === null || _c === void 0 ? void 0 : _c.idMesta, ")");
